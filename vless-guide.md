...
| Hiddify | NekoRay |
| ------- | ------- |
| :white_check_mark: Простой, красивый и понятный интерфейс | :eight_pointed_black_star: Более сложный и функциональный интерфейс |
| :white_check_mark: Настрока одной кнопкой | :eight_pointed_black_star: Настройка в нескольких подменю которые еще надо найти |
| :eight_pointed_black_star: Отсутствуют фильтры и шаблоны. В VLESS отправляется или весь ваш трафик, или весь трафик за исключением Российского (если выбран регион Россия) | :white_check_mark: Есть возможность задать любые фильтры по доменам, IP адресам, geoip и правила маршрутизации |
